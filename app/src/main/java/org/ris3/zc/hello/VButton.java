...
public class VButton {
    ...
    public interface VButtonCallback1 {
        void onSend();
        void onCancel();
    }
    ...
    public void check_preview(){
        ...
        Log.d(TAG, "check_preview time: " + t/1000 + "ms") ;
    }
    ...
    public void check_view(){
        ...
        if(state)
            ...
            doError();
        long t = System.nanoTime() - s ;
        Log.d(TAG, "check_view time: " + t/1000 + "ms") ;
    }
    ...
    public void SendInfo() {
        ...
        JsonObjectRequest joq =
                new JsonObjectRequest(getFullUrl("/devices/sendDevice"), followRequest,
    ...
    public void CheckInfo() {
        ...
        JsonObjectRequest joq =
                new JsonObjectRequest(getFullUrl("/devices"), followRequest,
                        new Response.Listener<JSONObject>() {
                            @Override
                            public void onResponse(JSONObject response) {
                                JSONObject followResp = null;
    ...
    public void RSACheck() {
        ...
        JsonObjectRequest joq =
                new JsonObjectRequest(getFullUrl("/devices/checkDevice"), followRequest,
                        new Response.Listener<JSONObject>() {
                            @Override
                            public void onResponse(JSONObject response) {
                                JSONObject followResp = null;
